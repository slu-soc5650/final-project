...
```{block, type = "rmdpre"}
**Pre-requisites:** Complete this vignette after receiving feedback from Chris on vignette 1.
```
...
```{block, type = "rmddue"}
**Required Due Date:** Meeting 05 (March 1st) 
```

```{block, type = "rmddeliver"}
**Deliverables:** A markdown file (`.md`) with properly formatted citations and evaluative assessments of each source; your spreadsheet documenting the search process.
```
